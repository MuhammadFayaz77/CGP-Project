...
<div className="flex flex-col items-center justify-center  bg-[#F9F9F9]">
 ...
 <p className=' text-[#0000008F] px-5 lg:px-0 lg:w-[55%] text-center   '>There are many variations of passages of Lorem Ipsum available
   but the majority have suffered alteration in some form</p></div>
