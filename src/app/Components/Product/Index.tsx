...
export default function Product() {
  return (
    <div className="bg-[#2E2E2E]   pt-2 lg:pt-24 flex justify-center items-center flex-col px4">
      <div className="text-center mb-8">
        <h1 className="text-xl sm:text-2xl md:text-4xl text-white font-semibold">
          Product/Module Examples
        </h1>
        <p className="text-sm sm:text-base text-[#FFFFFF8F] px-4  lg:max-w-[63%] lg:mb-12 mx-auto mt-2">
